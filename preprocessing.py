            ...
            [
                ...
                iaa.SomeOf(
                    ...
                    [
                        ...
                        iaa.OneOf([
                            iaa.Dropout(
                                (0.01, 0.1), per_channel=
                                0.5),  # randomly remove up to 10% of the pixels
            ...
            for obj in all_objs:
                if obj['xmax'] > obj['xmin'] and obj['ymax'] > obj['ymin'] and obj['name'] in self.config['LABELS']:
                    ...
                    if grid_x < self.config['GRID_W'] and grid_y < self.config['GRID_H']:
                        ...
                        y_batch[instance_count, grid_y, grid_x, best_anchor, 0:
                                4] = box
            ...
            if self.norm != None:
                ...
                for obj in all_objs:
                    if obj['xmax'] > obj['xmin'] and obj['ymax'] > obj['ymin']:
                        cv2.rectangle(img[:, :, ::-1], (obj['xmin'],
                                                        obj['ymin']),
                                      (obj['xmax'], obj['ymax']), (255, 0,
                                                                   0), 3)
