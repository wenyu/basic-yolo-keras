...
argparser.add_argument(
    '-c', '--conf', default='config.json', help='path to configuration file')

argparser.add_argument(
    '-a', '--anchors', default=5, help='number of anchors to use')
...
def run_kmeans(ann_dims, anchor_num):
    ...
    while True:
        ...
        for i in range(ann_num):
            ...
            distances.append(d)
        distances = np.array(
            distances)  # distances.shape = (ann_num, anchor_num)
